  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-[32rem] md:h-96 bg-slate-50 rounded-[2.5rem] overflow-hidden border-4 border-slate-100 shadow-inner">
      ...
      <div className="flex-1 relative flex items-center justify-center p-4 bg-white md:bg-transparent" onClick={() => setSelected(null)}>
         <svg viewBox="0 0 400 400" className="w-full h-full max-w-[300px] md:max-w-[350px] drop-shadow-xl">
            {/* AI Layer (Outer) */}
            <circle 
              cx="200" cy="200" r="190" 
              ...
              strokeDasharray="8 4"
              className="cursor-pointer transition-all duration-300 hover:stroke-[4px] hover:stroke-orange-400"
            ...
            <circle 
              ...
              className="cursor-pointer transition-all duration-300 hover:stroke-[4px] hover:stroke-blue-400"
            ...
            <circle 
              ...
              className="cursor-pointer transition-all duration-300 hover:stroke-[4px] hover:stroke-purple-400"
      ...
      <div className="h-48 md:h-auto md:w-80 bg-white border-t md:border-t-0 md:border-l border-slate-100 p-6 flex flex-col justify-center relative overflow-hidden">
         {activeData ? (
         ...
         <div className="absolute -bottom-10 -right-10 text-9xl opacity-5 pointer-events-none rotate-12">
            🧠
         </div>
      </div>
